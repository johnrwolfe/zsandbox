...
public class Employee_LeaveSetImpl extends InstanceSet<Employee_LeaveSet,Employee_Leave> implements Employee_LeaveSet {
    ...
    public EmployeeSet R1_Employee() throws XtumlException {
        ...
        for ( Employee_Leave employee_leave : this ) employeeset.add( employee_leave.R1_Employee() );
        return employeeset;
    }
    @Override
    public LeaveSet R1_Leave() throws XtumlException {
        LeaveSet leaveset = new LeaveSetImpl();
        for ( Employee_Leave employee_leave : this ) leaveset.add( employee_leave.R1_Leave() );
        return leaveset;
    }
