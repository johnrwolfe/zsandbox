...
public class EmployeeImpl extends ModelInstance<Employee,Hr> implements Employee {
    ...
    public static class newEmployeeRcvd extends Event {
        public newEmployeeRcvd(IRunContext runContext, int populationId,  final String p_FName,  final int p_National_ID,  final String p_LName ) {
            super(runContext, populationId, new Object[]{p_FName,  p_National_ID,  p_LName});
        }
        @Override
        public int getId() {
            return 0;
